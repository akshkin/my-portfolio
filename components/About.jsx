...
function About() {
	return (
		...
		<div className="p-8 max-w-5xl mx-auto text-xl mb-8" id="about">
			<h2 className="section-heading">ABOUT ME</h2>

			<p>
				As a web developer with 3+ years of continuous learning experience, my
				focus is on front-end development, utilizing HTML, CSS, JavaScript, and
				React to create intuitive user experiences. <br />I am passionate about
